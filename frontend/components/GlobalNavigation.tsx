...
import { GlobalNavigationSm } from './GlobalNavigationSm';
...
export const GlobalNavigation: React.FC = () => {
    ...
    return (
        <>
            <div
                className={cn(
                    'invisible fixed inset-0 z-11 transition-colors bg-transparent',
                    isMenuOpen && 'visible bg-black/50',
                )}
                onClick={() => setIsMenuOpen(false)}
            />
            <nav
                className={cn(
                    'invisible md:visible flex flex-col fixed left-0 top-0 bottom-0 w-(--global-nav-width) transition-transform -translate-x-(--global-nav-width) md:translate-none bg-gray-back z-12',
                    ...
                    {me ? (
                        ...
                        <ul>
                            ...
                            <li>
                                <a
                                    href="/login"
                                    className="p-2 rounded-sm hover:bg-neutral-200 flex items-center gap-2"
                                >
                    ...
                    <DropdownMenu.Root>
                        ...
                        <DropdownMenu.Portal>
                            <DropdownMenu.Content
                                className="p-2 w-(--radix-dropdown-menu-trigger-width) z-50 bg-white border-1 border-gray-border rounded shadow-md"
                                side="top"
                                align="start"
                            >
                                <DropdownMenu.Item
            ...
            <GlobalNavigationSm onOpenMenu={() => setIsMenuOpen(true)} />
        </>
    );
};
