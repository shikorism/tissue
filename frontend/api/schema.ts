...
export interface paths {
    ...
    "/likes/{id}": {
        ...
        put?: never;
        post?: never;
        delete: operations["Likes_delete"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/search/checkins": {
        ...
        get: operations["Search_checkins"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/search/collections": {
        ...
        get: operations["Search_collections"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    Likes_post: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": {
                        ejaculation: components["schemas"]["Checkin"];
                    };
                };
            };
            /** @description An unexpected error response. */
