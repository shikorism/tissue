...
<div class="container">
    <div class="row py-4">
        <div class="col-lg-4">
            <h1 class="text-center text-secondary display-1"><x-icon width="96" height="96" name="ballpen" /></h1>
        </div>
        <div class="col-lg-8">
    ...
    <div class="row py-4">
        <div class="col-lg-4">
            <h1 class="text-center text-secondary display-1"><x-icon width="96" height="96" name="timeline" /></h1>
        </div>
        <div class="col-lg-8">
    ...
    <div class="list-group list-group-flush">
        @foreach($informations as $info)
            ...
            @if ($info->pinned)
                <span class="badge badge-secondary"><x-icon width="12" height="12" name="filled-pinned" /> ピン留め</span>
            @endif
